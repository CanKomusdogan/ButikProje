...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../node_modules/swiper/swiper"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const swiper_1 = __importDefault(require("../../node_modules/swiper/swiper"));
    const productAddingSwiper = new swiper_1.default('#productAddingSwiper', {
        spaceBetween: 30,
        loop: true,
        pagination: {
    ...
    const productEditingSwiper = new swiper_1.default('#productEditingSwiper', {
        spaceBetween: 30,
        loop: true,
        pagination: {
            el: ".swiper-pagination",
    ...
    const productViewSwiper = new swiper_1.default('#productViewSwiper', {
        spaceBetween: 30,
        loop: true,
        pagination: {
            el: ".swiper-pagination",
